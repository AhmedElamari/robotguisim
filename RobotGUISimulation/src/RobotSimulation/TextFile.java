...
/**
 * A class for reading from and writing to text files User can define the
 * extension for such files Now exist methods to read/write whole file as single
...
public class TextFile {
	...
	/**
	 * constructor used to set up object ... pass it the description of files and
	 * extension
	 * 
	...
	/**
	 * report name of file used for reading/writing - empty string if open/create
	 * file failed
	 * 
	 * @return name of file
	 */
	...
	boolean getNextline() {
		...
		try {
			...
			if (fileLine != null)
				ok = true; // if not null, then line is there
		} catch (IOException e) {
